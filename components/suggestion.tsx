...
export default function Suggestion({
  ...
  return (
    <AnimatePresence>
      <div className="w-full border-white px-4 lg:px-0">
        {suggestedActions.map((action, index) => (
          <motion.button
            key={index}
            className="bg-background hover:bg-muted focus:bg-muted w-full cursor-pointer border-b p-3 pl-1 text-left font-sans text-sm lg:pl-0"
